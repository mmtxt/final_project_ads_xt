...
3.2. Delete lines without location information in the original dataset and create new dataset called cHHs.
...
3.4 I calculated the time each city shows in TX and LA, both in the data that containing a state information and without state information.
