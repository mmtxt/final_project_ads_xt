...
### 4.1 Basic row data exploration
...
### 4.2 Exclude other confounders by using the reference data
...
## 1.	The 20 cities that have the highest frequency:

Before the adjusting, we can see that there are several non-hurricane hit state are in the top 20 cities that have the most tweets, but most of them are from hurricane hit area. The cities that are in the top 20 all the five days(from sep 4th to sep 8th) are Houston, Austin, Dallas, Lasvegas, Boston, Sanantonio, Fortworth, Corpuschristi, Neworleans. The 9 cities listed above, besides Las vegas and boston, other cities are from state of TX and LA.
