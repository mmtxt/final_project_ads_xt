...
At the date 9/5, I got `` observations of ` `variables
At the date 9/6, I got `` observations of ` `variables
At the date 9/7, I got `` observations of ` `variables
At the date 9/8, I got `` observations of ` `variables
...
# for those have state information, remain state that have TX
